...
const STATUS_LABEL = { absent: '부재', anomaly: '이상', unregistered_uid: '미등록', wrong_room: '타내무반' };
        ...
        {!loading && detail && (
          <>
            <dl className="detail-grid">
              <dt>유형</dt>
              <dd>{STATUS_LABEL[detail.event.status_type] || detail.event.status_type}</dd>
              <dt>대상</dt>
              <dd>
                {detail.person
            ...
            <h4 className="section-title">이상 판단 근거</h4>
